...
def load_and_prepare_datasets(seed: int):
    ...
    DATA_PATH_DDG_1mel = "/data2/ssk/proteinMPNN/1mel/1melMPNN2_processed.csv"   #ΔΔGデータCSV
    DATA_PATH_DDG_4idl = "/data2/ssk/proteinMPNN/4idl/4idlMPNN2_processed.csv"   #ΔΔGデータCSV
