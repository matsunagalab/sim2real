...
def load_and_prepare_datasets(seed: int):
    ...
    DATA_PATH_DDG_1mel = "/data2/ssk/githubtest/sim2real/data/rosetta/1mel_rosettaddg_processed.csv"   #ΔΔGデータCSV
    DATA_PATH_DDG_4idl = "/data2/ssk/githubtest/sim2real/data/rosetta/4idl_rosettaddg_processed.csv"   #ΔΔGデータCSV
