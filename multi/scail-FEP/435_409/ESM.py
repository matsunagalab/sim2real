...
def load_and_prepare_datasets(seed: int):
    ...
    DATA_PATH_DDG_1mel = "/data2/ssk/githubtest/sim2real/data/fep/fep1mel_435_processed.csv"   #ΔΔGデータCSV
    DATA_PATH_DDG_4idl = "/data2/ssk/githubtest/sim2real/data/fep/fep4idl_409_processed.csv"   #ΔΔGデータCSV
